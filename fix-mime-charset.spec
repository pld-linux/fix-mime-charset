...
Summary(pl):	Popraw niepoprawne informacje o kodowaniu w nagЁСwkach maili MIME
...
wiadomo╤ciach pocztowych i modyfikuje odpowiednio nagЁСwek Content-Type.
Mo©e byФ wykorzystany jako filtr pocztowy w listach mailowych gdzie
u©ytkownicy czЙsto u©ywaj╠ nieprawidЁowo kodowania w nagЁСwkach. Szybko
i skutecznie przetwarza wiadomo╤ci, ignoruje zaЁ╠czniki i poprawnie
interpretuje kodowanie podczas transferu. 
Nie zmienia nic poza nagЁСwkiem Content-Type.
